...
You can read more about the package here: [PalmerPenguins](https://allisonhorst.github.io/palmerpenguins/)
...
data_types <- data.frame(Type=c("Numeric","Integer","Logical","Character"),Description = c(),"Exampe"=c("1.5,2.6","1,2","True/False","One cat,Two cats")

kable(useful_fct_1, caption = "Data types supported in R") %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
